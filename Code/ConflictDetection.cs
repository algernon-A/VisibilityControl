                    ...
                    switch (assembly.GetName().Name)
                    {
                        case "PropAnarchy":
                            ...
                            if (plugin.isEnabled)
                            {
                                ...
                                {
                                    // Prop & Tree Anarchy (original BP) is fine.
                                }
                                else
                                {
                                    // Prop Anarchy (Quistar).
                                    conflictingModNames.Add("PropAnarchy");
                                }
                            }
                        ...
                        case "AdditiveShader":
                            ...
                            if (plugin.isEnabled)
                            {
                                // Additive shader.
                                conflictDetected = true;
                                conflictingModNames.Add("Additive Shader");
                            }
                        ...
                        case "LodFixer":
                            ...
                            if (plugin.isEnabled)
                            {
                                ...
                                conflictDetected = true;
                                conflictingModNames.Add("Transparency LODs Fix");
                            }
