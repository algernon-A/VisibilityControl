...
namespace VisibilityControl
{
    ...
    internal sealed class TransparencyOptions
    {
        ...
        internal TransparencyOptions(UITabstrip tabStrip, int tabIndex)
        {
            ...
            _buildingMinimumDistanceSlider = UISliders.AddPlainSliderWithIntegerValue(panel, LeftMargin, currentY, Translations.Translate("MIN_DISTANCE"), MinMinimumDistance, MaxMinimumDistance, 1f, BuildingMinimumDistance);
            ...
            _buildingLodTransitionSlider = UISliders.AddPlainSliderWithValue(panel, LeftMargin, currentY, Translations.Translate("LOD_TRANSITION"), MinLODTransitionMultiplier, MaxLODTransitionMultiplier, 0.05f, BuildingLODTransitionMultiplier);
            ...
            _propMinimumDistanceSlider = UISliders.AddPlainSliderWithIntegerValue(panel, LeftMargin, currentY, Translations.Translate("MIN_DISTANCE"), MinMinimumDistance, MaxMinimumDistance, 1f, PropMinimumDistance);
            ...
            _propDistanceMultiplierSlider = UISliders.AddPlainSliderWithIntegerValue(panel, LeftMargin, currentY, Translations.Translate("DISTANCE_MULT"), MinDistanceMultiplier, MaxDistanceMultiplier, 1f, PropDistanceMultiplier);
            ...
            _propLodTransitionSlider = UISliders.AddPlainSliderWithValue(panel, LeftMargin, currentY, Translations.Translate("LOD_TRANSITION"), MinLODTransitionMultiplier, MaxLODTransitionMultiplier, 0.05f, PropLODTransitionMultiplier);
